            ...
            instance =
                    new SwerveDrive(
                            new SPSwerveModule(
                                    ...
                                    Ports.Swerve.FrontRight.TURN_ENCODER,
                                    Ports.Swerve.FrontRight.DRIVE_MOTOR,
                                    FrontRight.MODULE_LOCATION,
                                    FrontRight.WHEEL_ROTATION_OFFSET),
                            new SPSwerveModule(
                                    FrontLeft.ID,
                                    Ports.Swerve.FrontLeft.TURN_MOTOR,
                                    Ports.Swerve.FrontLeft.TURN_ENCODER,
                                    Ports.Swerve.FrontLeft.DRIVE_MOTOR,
                                    FrontLeft.MODULE_LOCATION,
                                    FrontLeft.WHEEL_ROTATION_OFFSET),
                            new SPSwerveModule(
                                    BackLeft.ID,
                                    Ports.Swerve.BackLeft.TURN_MOTOR,
                                    Ports.Swerve.BackLeft.TURN_ENCODER,
                                    Ports.Swerve.BackLeft.DRIVE_MOTOR,
                                    BackLeft.MODULE_LOCATION,
                                    BackLeft.WHEEL_ROTATION_OFFSET),
                            new SPSwerveModule(
                                    BackRight.ID,
                                    Ports.Swerve.BackRight.TURN_MOTOR,
                                    Ports.Swerve.BackRight.TURN_ENCODER,
                                    Ports.Swerve.BackRight.DRIVE_MOTOR,
                                    BackRight.MODULE_LOCATION,
                                    BackRight.WHEEL_ROTATION_OFFSET));
